...
def question_selection(df_raw, groupby_col):
    ...
    """
    # Assings values from dataframe to variables
...
def call_survey_results():
    """
    This function wait for the user to press enter to return to
    previous menu generated by survey_results
    """
    input()
    clear_screen()
    survey_results()
...
def first_selection():
    ...
    and viewing the survey results or exit the program.
    """
    selection = 0
    while selection != 1 and selection != 2 and selection != 3:
        try:
...
def get_survey():
    ...
    """
    # Generate df_answers as a variable removing questions from dataframe
    data = SHEET.worksheet('predefined_answers').get_all_values()
...
def completed_survey_options():
    ...
    The user can retake the survey, submit and view results or submit
    and exit.
    """
    clear_screen()
...
def welcome():
    ...
    clear_screen()
    print("\n")
    print(BLUE + instrucctions[1].upper())
    print("\n")
    print(WHITE + instrucctions[2].upper())
    print(WHITE + instrucctions[3].upper() + RESET)
    print("\n")
    input(YELLOW + BRIGHT +
    ...
    print("\n")
    print("\n")
    print(WHITE + instrucctions[4].upper())
    print(WHITE + instrucctions[5].upper())
    print(WHITE + instrucctions[6].upper())
    print(WHITE + instrucctions[7].upper() + RESET)
    print("\n")
    input(YELLOW + BRIGHT +
          "                            press Enter to continue")
    clear_screen()
...
def goodbye():
    ...
    and ask if he/she really wants to exit.
    """
    selection = 0
